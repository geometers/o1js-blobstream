...
def bits_to_bytearray(bits):
    ...
    # Group bits into bytes and convert each group to a byte
...
def pad_741(s: str): 
    ...
    # bits_to_pad = 1 + 0*(k + 64 - 13) + bin(l) 

    k = 151 

    bits_to_pad = [1]
    for _ in range(k + 64 - 13): 
        bits_to_pad.append(0)

    return bits_to_pad + [1, 0, 1, 1, 1, 0, 0, 1, 0, 1, 0, 0, 0]

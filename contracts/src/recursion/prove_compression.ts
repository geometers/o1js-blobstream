...
// const p1 = await ZKP0Proof.fromJSON(JSON.parse(fs.readFileSync('./src/recursion/proofs/zkp1.json', 'utf8')));
// const p2 = await ZKP1Proof.fromJSON(JSON.parse(fs.readFileSync('./src/recursion/proofs/zkp2.json', 'utf8')));
// const p3 = await ZKP2Proof.fromJSON(JSON.parse(fs.readFileSync('./src/recursion/proofs/zkp3.json', 'utf8')));
// const p4 = await ZKP3Proof.fromJSON(JSON.parse(fs.readFileSync('./src/recursion/proofs/zkp4.json', 'utf8')));

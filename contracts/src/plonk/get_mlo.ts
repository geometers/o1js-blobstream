...
const Verifier = new Sp1PlonkVerifier(VK, g2_lines, tau_lines, w27, w27_square)
...
const mlo = Verifier.computeMlo(proof, pi0, pi1);

// console.log(mlo.toJSON())

const filePath = '../mlo.json';
fs.writeFileSync(filePath, mlo.toJSON(), 'utf-8');

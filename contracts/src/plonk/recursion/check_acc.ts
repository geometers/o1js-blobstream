...
const [acc_13, _] = wt.zkp12(get_shift_power(), make_c());


console.log(Poseidon.hashPacked(KzgAccumulator, acc_13).toBigInt())

console.log("A.x: ", acc_13.proof.A.x.toBigInt())
console.log("A.y: ", acc_13.proof.A.y.toBigInt())
console.log("-B.x: ", acc_13.proof.negB.x.toBigInt())
console.log("-B.y: ", acc_13.proof.negB.y.toBigInt())
